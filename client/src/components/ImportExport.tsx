...
export default function ImportExport() {
    ...
    function handleExport() {
        axios.get(EXPORT_URL).then((response) => {
    ...
    return (
        <>
            <Button onClick={handleShow}>Импорт/Экспорт данных</Button>
                        ...
                        <Modal.Body>
                            <Form onSubmit={handleImport}>
                                <Form.Group controlId="formFile" className="mb-3">
                                    <Form.Label>Выберите файл, содержащий данные для всего приложения.</Form.Label>
